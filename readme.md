...
<!-- `<gc.dev/>` — Versão completa curta, com o sufixo em indigo como no wordmark. -->
<img
  src="https://raw.githubusercontent.com/https-shini/skill-icons/main/brand/gc-dev-dark.svg"
  width="380"
  alt="gcruz.dev"
/>

<!-- `<gcruz/>` — Baseada no nome, sem o sufixo de domínio. -->
<img
  src="https://raw.githubusercontent.com/https-shini/skill-icons/main/brand/gcruz-tag-dark.svg"
  width="370"
  alt="gcruz.dev"
/>

<!-- `gc` — Mínima: favicon, avatar e espaços reduzidos. -->
<img
  src="https://raw.githubusercontent.com/https-shini/skill-icons/main/brand/gc-dark.svg"
  width="120"
  alt="gcruz.dev"
/>
```
...
Os ícones da marca. Detalhes e assets em [Ícones da marca](#ícones-da-marca-gcruzdev).
